...
exports.isValidContact = exports.getPropertyDetails = exports.getEquipmentsList = void 0;
...
var equipmentListUrl = "".concat("http://localhost:3000/api", "/equipments"); //equipments del data.json
...
var FormUrl = "".concat("http://localhost:3000/api", "/contact"); //esto está en el .env

var isValidContact = function isValidContact(contact) {
  return _axios.default.post(FormUrl, contact) //post porque vamos a enviar desde la url con los datos del login
...
},{}],"pages/property-detail/property-details.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapPropertyFromApiToViewModel = void 0;

var mapPropertyFromApiToViewModel = function mapPropertyFromApiToViewModel(property, equipment) {
  return {
    id: property.id,
    ...
    mainImage: Array.isArray(property.images) ? property.images[1] : '',
    //si hay algo en property images coge la 1ª, si no vacío
...
var getBathroomsWord = function getBathroomsWord(bathrooms) {
  return bathrooms > 1 ? "baños" : "baño";
};

var getEquipmentName = function getEquipmentName(property, equipment) {
  var ids = "";
  ids = property.equipmentIds.map(function (obj) {
    var nameEquipment = equipment.find(function (el) {
      return el.id === obj;
    });
...
},{}],"pages/property-detail/property-details.validators.js":[function(require,module,exports) {
"use strict";
...
var _propertyDetails = require("./property-details.mappers");

var _propertyDetails2 = require("./property-details.validators");
...
(0, _propertyDetail.getPropertyDetails)(params.id), (0, _propertyDetail.getEquipmentsList)()]).then(function (resultList) {
  var _resultList = _slicedToArray(resultList, 2),
      propertyDetails = _resultList[0],
      getEquipmentsList = _resultList[1]; //el resultado de cada lista (desestructuring)


  var viewModelPropertyList = (0, _propertyDetails.mapPropertyFromApiToViewModel)(propertyDetails, getEquipmentsList);
  (0, _propertyDetail2.setPropertyValues)(viewModelPropertyList);
});
var property = {
  //hacemos nuestro modelo para recoger los datos
  id: '',
  title: '',
  rooms: '',
  bathrooms: '',
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _propertyDetails2.formValidation.validateField('email', contact.email).then(function (result) {
...
(0, _helpers.onUpdateField)('message', function (event) {
  ...
  _propertyDetails2.formValidation.validateField('message', contact.message).then(function (result) {
    (0, _helpers.onSetError)('message', result);
  });
});
(0, _helpers.onSubmitForm)('contact-button', function () {
  _propertyDetails2.formValidation.validateForm(contact).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);

    if (result.succeeded) {
      (0, _propertyDetail.isValidContact)(contact).then(function (isValid) {
        console.log({
          isValid: isValid
        });
...
},{"../../core/router":"core/router/index.js","./property-detail.api":"pages/property-detail/property-detail.api.js","./property-detail.helpers":"pages/property-detail/property-detail.helpers.js","./property-details.mappers":"pages/property-detail/property-details.mappers.js","./property-details.validators":"pages/property-detail/property-details.validators.js","../../common/helpers":"common/helpers/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
