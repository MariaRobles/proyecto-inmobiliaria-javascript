...
exports.isValidProperty = exports.getSalesTypeList = exports.getProvincesList = exports.getEquipmentsList = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var url = "".concat("http://localhost:3000/api", "/properties"); //porperties del data.json

var isValidProperty = function isValidProperty(newProperty) {
...
var salesTypeListUrl = "".concat("http://localhost:3000/api", "/saleTypes");

var getSalesTypeList = function getSalesTypeList() {
  return _axios.default.get(salesTypeListUrl).then(function (response) {
    return response.data;
  });
};
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-is-number-validator":"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js","@lemoncode/fonk-is-url-validator":"../node_modules/@lemoncode/fonk-is-url-validator/dist/@lemoncode/fonk-is-url-validator.esm.js","@lemoncode/fonk-array-required-validator":"../node_modules/@lemoncode/fonk-array-required-validator/dist/@lemoncode/fonk-array-required-validator.esm.js"}],"pages/upload-property/upload-property.helpers.js":[function(require,module,exports) {
"use strict";
...
var _uploadProperty2 = require("./upload-property.validators");
...
Promise.all([(0, _uploadProperty.getEquipmentsList)(), (0, _uploadProperty.getProvincesList)(), (0, _uploadProperty.getSalesTypeList)()]).then(function (resultList) {
  var _resultList = _slicedToArray(resultList, 3),
      equipmentsList = _resultList[0],
      provincesList = _resultList[1],
      salesTypeList = _resultList[2]; //el resultado de cada lista (desestructuring)
  //helpers


  (0, _uploadProperty3.setOptionList)(provincesList, 'province');
  (0, _uploadProperty3.setCheckboxList)(equipmentsList, 'equipments');
  setEquipment(equipmentsList);
  (0, _uploadProperty3.setCheckboxList)(salesTypeList, 'saleTypes');
  setSalesType(salesTypeList);
});

var setSalesType = function setSalesType(list) {
  list.forEach(function (el) {
    var id = (0, _uploadProperty3.formatCheckboxId)(el);
    (0, _helpers.onUpdateField)(id, function (event) {
      var value = event.target.value;
      newProperty = _objectSpread(_objectSpread({}, newProperty), {}, {
        saleTypes: [].concat(_toConsumableArray(newProperty.saleTypes), [value])
      });
    });
  });
};

var setEquipment = function setEquipment(list) {
  list.forEach(function (el) {
    var id = (0, _uploadProperty3.formatCheckboxId)(el);
    (0, _helpers.onUpdateField)(id, function (event) {
      var value = event.target.value;
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty2.formValidation.validateField('city', newProperty.province).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty2.formValidation.validateField('city', newProperty.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty2.formValidation.validateField('city', newProperty.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty2.formValidation.validateField('city', newProperty.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty2.formValidation.validateField('city', newProperty.locationUrl).then(function (result) {
...
(0, _helpers.onSubmitForm)('insert-feature-button', function () {
  ...
  if (value) {
    ...
    (0, _uploadProperty3.formatDeleteFeatureButtonId)(value);
    (0, _uploadProperty3.onAddFeature)(value);
    (0, _helpers.onSubmitForm)(["delete-".concat(value, "-button")], function () {
...
(0, _helpers.onAddFile)('add-image', function (img) {
  ...
  (0, _uploadProperty3.onAddImage)(img);

  _uploadProperty2.formValidation.validateField('images', newProperty.images).then(function (result) {
...
(0, _helpers.onSubmitForm)('save-button', function () {
  _uploadProperty2.formValidation.validateForm(newProperty).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _uploadProperty.isValidProperty)(newProperty).then(function (isValid) {
        console.log({
          isValid: isValid
        });
...
},{"../../common/helpers":"common/helpers/index.js","./upload-property.api":"pages/upload-property/upload-property.api.js","./upload-property.validators":"pages/upload-property/upload-property.validators.js","./upload-property.helpers":"pages/upload-property/upload-property.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
