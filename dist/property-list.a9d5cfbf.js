...
exports.getSaleTypeList = exports.getProvincesList = exports.getPropertyList = void 0;
...
var getPropertyList = function getPropertyList(queryParams) {
  return _axios.default.get("".concat(url, "?").concat(queryParams)).then(function (response) {
    //esto lo hemos actualizado para pasarle las queryParams (en este caso los ids)
...
var mapPropertyfromApitoViewModel = function mapPropertyfromApitoViewModel(property) {
  //esto es para una sola propiedad
  return {
    id: property.id,
    ...
    //cogemos sólo desde el caracter 0 al 240
...
var mapFilterToQueryParams = function mapFilterToQueryParams(filter) {
  ...
  if (filter.saleTypeId) {
    queryParams = "".concat(queryParams, "saleTypeIds_like=").concat(filter.saleTypeId, "&"); //_like= que el dato esté dentro de un array
  }
  ...
  if (filter.minPrice) {
    queryParams = "".concat(queryParams, "price_gte=").concat(filter.minPrince, "&");
  }

  ;

  if (filter.maxPrice) {
    queryParams = "".concat(queryParams, "price_lte=").concat(filter.maxPrince, "&");
  }
...
//aquí vamos a definir los arrays para número de habitaciones, precios etc
var roomOptions = [{
  id: '1',
  name: '+1'
}, {
...
(0, _propertyList.getPropertyList)(), (0, _propertyList.getSaleTypeList)(), (0, _propertyList.getProvincesList)()]).then(function (resultList) {
  var _resultList = _slicedToArray(resultList, 3),
      propertyList = _resultList[0],
      saleTypeList = _resultList[1],
      provinceList = _resultList[2]; //el resultado de cada lista (desestructuring)


  loadPropertyList(propertyList); //listado de propiedades

  (0, _propertyList3.setOptions)(saleTypeList, 'select-sale-type', '¿Que venta?'); //helpers

  (0, _propertyList3.setOptions)(provinceList, 'select-province', '¿Dónde?');
  (0, _propertyList3.setOptions)(_propertyList4.roomOptions, 'select-room', '¿Cúantas habitaciones?');
  (0, _propertyList3.setOptions)(_propertyList4.bathroomOptions, 'select-bathroom', '¿Cúantos baños?');
